...
const services = [
  ...
  },
  {
    ...
    text: 'Os serviços elétricos da Marcondes Manutenção são realizados por profissionais altamente capacitados e experientes na área. Nós nos comprometemos em garantir a segurança de nossos clientes e de nossos funcionários, aplicando as normas e regulamentos elétricos necessários em cada projeto.',
    servicos: [
  ...
  },
  {
    ...
    text: 'Os serviços hidráulicos oferecidos pela Marcondes Manutenção são realizados por profissionais altamente capacitados e experientes na área.',
    servicos: [
